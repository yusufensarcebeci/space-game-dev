    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Number), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        handleTouchMove(event) {
          ...
          var uiTransform = this.node.getComponent(UITransform); // Ekran pozisyonunu düğüm pozisyonuna dönüştür

          var pos = uiTransform.convertToNodeSpaceAR(new Vec3(screenPos.x, screenPos.y, 0)); // Joystick merkezine göre offset hesapla

          var offset = new Vec3(pos.x - this.joystickCenter.x, pos.y - this.joystickCenter.y, 0);
          var distance = offset.length(); // Joystick hareket alanını sınırla

          if (distance > this.joystickRadius) {
            offset.normalize(); // Offset'i normalize et (birim vektör)

            offset.multiplyScalar(this.joystickRadius / 2); // Joystick yarıçapı ile çarp

            pos.set(this.joystickCenter.x + offset.x, this.joystickCenter.y + offset.y, 0);
          } // Joystick'in pozisyonunu güncelle
...
//# sourceMappingURL=2d7080fee641783fb142808ba7a154615c3cfb6a.js.map