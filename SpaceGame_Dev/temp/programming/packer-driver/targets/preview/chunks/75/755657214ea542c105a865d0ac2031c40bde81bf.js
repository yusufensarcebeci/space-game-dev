  ...
  return {
    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(Prefab), _dec3 = property(Number), _dec4 = property(Number), _dec5 = property(Number), _dec(_class = (_class2 = class EnemyManager extends Component {
        ...
        spawnEnemy() {
          var availableEnemies = this.enemyPool.filter(enemy => !enemy.active);
          ...
          var enemy = availableEnemies[Math.floor(Math.random() * availableEnemies.length)];
          var randomX = randomRange(-this.spawnRangeX, this.spawnRangeX);
          var randomY = randomRange(-this.spawnRangeY, this.spawnRangeY);
          var spawnPosition = new Vec3(randomX, randomY, this.spawnDepth);
...
//# sourceMappingURL=755657214ea542c105a865d0ac2031c40bde81bf.js.map