  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        error: Error()
      }), SceneFrame) : SceneFrame), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "loadingScreen", _descriptor4, this);

          _initializerDefineProperty(this, "initScreen", _descriptor5, this);

          _initializerDefineProperty(this, "gameScreen", _descriptor6, this);

          _initializerDefineProperty(this, "endScreen", _descriptor7, this);

          _initializerDefineProperty(this, "scoreHandlerNode", _descriptor8, this);

          _initializerDefineProperty(this, "load", _descriptor9, this);
        }
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "loadingScreen", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "initScreen", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "gameScreen", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "endScreen", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "scoreHandlerNode", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "load", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=fdc38fdec31a6c8f267f11ba83f8861902d4e33e.js.map