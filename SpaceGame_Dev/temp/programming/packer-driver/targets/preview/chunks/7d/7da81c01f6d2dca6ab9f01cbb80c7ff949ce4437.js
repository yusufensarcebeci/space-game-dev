System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, randomRange, Vec3, GameManager, GameState, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, EnemyManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        spawnAllEnemies() {
          var positionZ = this.initialPosZ;
          this.enemyPool.forEach(enemy => {
            var spawnPos = new Vec3(randomRange(-this.spawnRangeX, this.spawnRangeX), randomRange(-this.spawnRangeY, this.spawnRangeY), positionZ);
        ...
        resetEnemy(enemy) {
          ...
          var spawnPos = new Vec3(randomRange(-this.spawnRangeX, this.spawnRangeX), randomRange(-this.spawnRangeY, this.spawnRangeY), this.getFarthestEnemyZ() - this.zOffset);
...
//# sourceMappingURL=7da81c01f6d2dca6ab9f01cbb80c7ff949ce4437.js.map