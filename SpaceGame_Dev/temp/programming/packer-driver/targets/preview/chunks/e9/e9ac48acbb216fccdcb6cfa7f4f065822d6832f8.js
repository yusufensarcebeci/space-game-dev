  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        increaseDifficulty() {
          this.difficultyMultiplier += this.difficultyIncreaseRate;
          console.log("Difficulty increased: ", this.difficultyMultiplier);
        }

        update(dt) {
          if (this.currentState === GameState.GAME_RUNNING) {
            this.schedule(this.increaseDifficulty.bind(this), this.increaseInterval);
...
//# sourceMappingURL=e9ac48acbb216fccdcb6cfa7f4f065822d6832f8.js.map