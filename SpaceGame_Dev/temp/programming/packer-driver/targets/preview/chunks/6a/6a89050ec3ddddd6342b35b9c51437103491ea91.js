System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, Vec3, GameManager, GameState, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, SceneFrame;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SceneFrame", SceneFrame = (_dec = ccclass("SceneFrame"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        error: Error()
      }), GameManager) : GameManager), _dec3 = property(Prefab), _dec4 = property(Number), _dec5 = property(Number), _dec(_class = (_class2 = class SceneFrame extends Component {
        constructor() {
          super(...arguments);
        ...
        resetFrame(frame) {
          var newPositionZ = this.getFarthestFrameZ() - this.zOffset;
...
//# sourceMappingURL=6a89050ec3ddddd6342b35b9c51437103491ea91.js.map