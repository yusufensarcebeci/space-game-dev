  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        onPlayButtonClicked() {
          var gameManager = this.getComponent(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
...
//# sourceMappingURL=84928e832e8536be21feabec1d745a99810828a7.js.map