    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Number), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        handleTouchMove(event) {
          ...
          var offset = new Vec3(pos.x - this.joystickCenter.x / 2, pos.y - this.joystickCenter.y / 2, 0);
          var distance = offset.length();

          if (distance > this.joystickRadius) {
            offset.normalize().multiplyScalar(this.joystickRadius / 2);
...
//# sourceMappingURL=ab53332ec7ab378059c3971fedecc573581e31e2.js.map