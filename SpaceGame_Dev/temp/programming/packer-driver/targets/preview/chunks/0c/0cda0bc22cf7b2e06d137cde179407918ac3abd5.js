    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Number), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        handleTouchMove(event) {
          var screenPos = event.getLocationInView();
          var uiTransform = this.node.getComponent(UITransform);
          var nodePos = uiTransform.convertToNodeSpaceAR(new Vec3(screenPos.x, screenPos.y, 0));
          var stickPos = new Vec3(nodePos.x - this.joystickCenter.x, nodePos.y - this.joystickCenter.y, 0);
      ...
      })), _class2)) || _class)); // const offset = new Vec3(
...
//# sourceMappingURL=0cda0bc22cf7b2e06d137cde179407918ac3abd5.js.map