  ...
  return {
    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        resetEnemy(enemy) {
          var newPositionZ = this.getFarthestEnemyZ() - this.zOffset;
          enemy.setPosition(new Vec3(0, 0, newPositionZ));
        }
...
//# sourceMappingURL=ca27a25e42c22265b105c41eb0c56f35c5b34a0b.js.map