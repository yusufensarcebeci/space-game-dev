    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(Prefab), _dec3 = property(Number), _dec4 = property(Number), _dec5 = property(Number), _dec6 = property(Number), _dec7 = property(Number), _dec8 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        constructor() {
          ...
          // Z ekseninde her bir düşman arasındaki mesafe
        ...
        spawnAllEnemies() {
          var currentZ = this.spawnDepth;

          for (var enemy of this.enemyPool) {
            var spawnPos = new Vec3(randomRange(-this.spawnRangeX, this.spawnRangeX), randomRange(-this.spawnRangeY, this.spawnRangeY), currentZ);
        ...
        update(dt) {
          if (this.gameManager && this.gameManager.currentState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            ...
            this.activeEnemies.forEach(enemy => {
              ...
              enemy.setPosition(position); // if (position.z > someThreshold) {
...
//# sourceMappingURL=8d31de86a23ce1784c5348dcbfa170392bf7b027.js.map