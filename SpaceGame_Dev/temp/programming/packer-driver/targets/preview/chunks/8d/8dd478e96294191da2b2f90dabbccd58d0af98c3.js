        ...
        update(deltaTime) {
          if (this.joystickController) {
            ...
            if (direction.length() > 0) {
              var moveVector = new Vec3(direction.x, direction.y, 0).multiplyScalar(this.movementSpeed * deltaTime);
...
//# sourceMappingURL=8dd478e96294191da2b2f90dabbccd58d0af98c3.js.map