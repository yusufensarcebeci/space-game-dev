        ...
        update(dt) {
          if (this.joystickController) {
            ...
            if (direction.length() > 0) {
              ...
              var newPosition = this.node.getPosition().add(moveVector); //Player Hareket Alanını Sınırlandırma 
...
//# sourceMappingURL=93443ac3da07184c8a066b8bc348795fcf373d4a.js.map