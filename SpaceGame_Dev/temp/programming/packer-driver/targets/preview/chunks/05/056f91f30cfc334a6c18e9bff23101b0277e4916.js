System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec2, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, JoystickController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventTouch', 'Input', 'input', 'Node', 'Vec2', 'Vec3']);
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        onLoad() {
          console.log(this.node.name); // this.node.on(Node.EventType.TOUCH_START,this.onTouchStart,this)
...
//# sourceMappingURL=056f91f30cfc334a6c18e9bff23101b0277e4916.js.map