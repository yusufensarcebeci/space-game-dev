System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, Vec3, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, SceneFrame;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SceneFrame", SceneFrame = (_dec = ccclass("SceneFrame"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        update(dt) {//   if (this.gameManager && this.gameManager.currentState === GameState.GAME_START) {
          //     this.framePool.forEach((frame) => {
...
//# sourceMappingURL=5de15cdf91442d0f99a5b971b299ac3fb7fdc1bf.js.map