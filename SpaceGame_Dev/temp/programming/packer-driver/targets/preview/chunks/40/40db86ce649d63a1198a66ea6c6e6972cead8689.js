System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, GameManager, GameState, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ScoreHandler;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScoreHandler", ScoreHandler = (_dec = ccclass("ScoreHandler"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        error: Error()
      }), GameManager) : GameManager), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Number), _dec6 = property(Number), _dec(_class = (_class2 = class ScoreHandler extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "incrementInterval", _descriptor5, this);
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "score", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "incrementInterval", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=40db86ce649d63a1198a66ea6c6e6972cead8689.js.map