  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScoreHandler", ScoreHandler = (_dec = ccclass("ScoreHandler"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        error: Error()
      }), GameManager) : GameManager), _dec3 = property(Node), _dec4 = property(Number), _dec5 = property(Number), _dec(_class = (_class2 = class ScoreHandler extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=a2431cdb424840686401c27fab53a49fd3d93512.js.map