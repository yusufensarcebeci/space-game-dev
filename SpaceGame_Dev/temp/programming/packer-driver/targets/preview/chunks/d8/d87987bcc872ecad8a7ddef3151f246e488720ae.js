System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, math, Quat, Vec3, _dec, _class, _crd, ccclass, property, Camera;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'math', 'Node', 'Quat', 'Vec3']);
      ...
      _export("Camera", Camera = (_dec = ccclass("Camera"), _dec(_class = class Camera extends Component {
        constructor() {
          ...
          this.rotOffset = new Quat(math.toRadian(-9), 0, 0, 1);
...
//# sourceMappingURL=d87987bcc872ecad8a7ddef3151f246e488720ae.js.map