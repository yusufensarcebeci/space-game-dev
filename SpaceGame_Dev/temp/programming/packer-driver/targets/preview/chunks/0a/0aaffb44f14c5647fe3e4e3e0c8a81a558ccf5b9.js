    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Number), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        handleTouchMove(event) {
          ...
          this.stick.setPosition(this.joystickCenter.x + offset.x, this.joystickCenter.y + offset.y, 0); // Yön bilgisini normalize ederek güncelle
...
//# sourceMappingURL=0aaffb44f14c5647fe3e4e3e0c8a81a558ccf5b9.js.map