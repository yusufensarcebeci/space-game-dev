  ...
  return {
    ...
    execute: function () {
      ...
      _export("SceneFrame", SceneFrame = (_dec = ccclass("SceneFrame"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        resetFrame(frame) {
          frame.setPosition(this.tempVec3.set(0, 0, this.positionZ));
          this.positionZ -= this.zOffset;
        }
        ...
        update(dt) {
          if (this.gameManager && this.gameManager.currentState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).GAME_START) {// this.framePool.forEach((frame) => {
...
//# sourceMappingURL=d63e96dfc46c2e4520fec8b82aee6e22972aeb3c.js.map