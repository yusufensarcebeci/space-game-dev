System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Node, Prefab, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, EnemyManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(Prefab), _dec3 = property(Number), _dec4 = property(Number), _dec5 = property(Number), _dec6 = property(Node), _dec(_class = (_class2 = class EnemyManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        initializeEnemyPool() {
          for (let i = 0; i < this.poolSize; i++) {
            ...
            this.node.addChild(enemy); // EnemyManager'a bağlı hale getir
          }
        }
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "parent", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=b4fe46072ed59a9f0d5da7fbb4f6304f1b297573.js.map