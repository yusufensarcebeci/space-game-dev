  ...
  return {
    ...
    execute: function () {
      ...
      _export("SceneFrame", SceneFrame = (_dec = ccclass("SceneFrame"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        resetFrame(frame) {
          const lastFramePosZ = this.lastFrame.position.z;
          frame.setPosition(this.tempVec3.set(0, 0, lastFramePosZ - this.zOffset)); //   this.positionZ -= this.zOffset;
        }
...
//# sourceMappingURL=f783cfebe6a8c64c39daa834cebc44898dc155ed.js.map