  ...
  return {
    ...
    execute: function () {
      ...
      _export("Player", Player = (_dec = ccclass("Player"), _dec2 = property(Number), _dec3 = property(_crd && JoystickController === void 0 ? (_reportPossibleCrUseOfJoystickController({
        error: Error()
      }), JoystickController) : JoystickController), _dec4 = property(_crd && Camera === void 0 ? (_reportPossibleCrUseOfCamera({
        error: Error()
      }), Camera) : Camera), _dec(_class = (_class2 = class Player extends Component {
        constructor(...args) {
          super(...args);
        ...
        lateUpdate(dt) {// this.camera.follow(this.node)
        }
...
//# sourceMappingURL=9f9caa1ef270b87247b4618e359f78938fac17fc.js.map