    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "scoreHandlerNode", _descriptor7, this);
        }
        ...
        handleGameScreen() {
          ...
          if (this.gameScreen) {
            ...
            if (this.scoreHandlerNode) {
              ...
              if (scoreHandler) {
                scoreHandler.score = 0; // Skoru sıfırlayın
              }
            }
          }
        }
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "scoreHandlerNode", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=fc50b660cba106229216bae6f67c85c1c4ccb1ef.js.map