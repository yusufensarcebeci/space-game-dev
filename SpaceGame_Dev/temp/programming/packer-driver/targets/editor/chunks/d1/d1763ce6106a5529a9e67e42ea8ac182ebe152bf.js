    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Number), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        handleTouchMove(event) {
          ...
          const uiTransform = this.node.getComponent(UITransform); // Ekran pozisyonunu düğüm pozisyonuna dönüştür

          const pos = uiTransform.convertToNodeSpaceAR(new Vec3(screenPos.x, screenPos.y, 0)); // Joystick merkezine göre offset hesapla

          const offset = new Vec3(pos.x - this.joystickCenter.x, pos.y - this.joystickCenter.y, 0);
          const distance = offset.length(); // Joystick hareket alanını sınırla
...
//# sourceMappingURL=d1763ce6106a5529a9e67e42ea8ac182ebe152bf.js.map