System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, GameState, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, ScoreHandler;
      ...
      _export("ScoreHandler", ScoreHandler = (_dec = ccclass("ScoreHandler"), _dec2 = property(Node), _dec3 = property(Number), _dec4 = property(Number), _dec(_class = (_class2 = class ScoreHandler extends Component {
        ...
        update(dt) {
          if ((_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).GAME_RUNNING) this.elapsedTime += dt;
...
//# sourceMappingURL=60ca4468de012d30f598586faed0a8b1da0d8e7d.js.map