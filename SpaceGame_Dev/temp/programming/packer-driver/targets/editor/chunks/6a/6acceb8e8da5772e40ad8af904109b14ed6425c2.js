System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, clamp, Component, Vec3, JoystickController, Camera, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Player;
        ...
        update(dt) {
          if (this.joystickController) {
            ...
            if (direction.length() > 0) {
              ...
              const newPosition = this.node.getPosition().add(moveVector); //Player Hareket Alanını Sınırlandırma 
...
//# sourceMappingURL=6acceb8e8da5772e40ad8af904109b14ed6425c2.js.map