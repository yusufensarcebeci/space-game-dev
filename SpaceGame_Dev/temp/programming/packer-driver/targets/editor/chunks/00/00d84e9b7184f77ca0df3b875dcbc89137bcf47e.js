    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        onLoading() {
          ...
          this.uIManager.handleLoading();
        } // Proje başlangıç işlemleri burada yapılır


        onGameInitialized() {
          console.log("Game initialized!");
          this.uIManager.handleInitScreen();
        } // Oyun başlatma işlemleri burada yapılır


        onGameStart() {
          console.log("Game Begin!"); // this.uIManager.handleGameScreen
...
//# sourceMappingURL=00d84e9b7184f77ca0df3b875dcbc89137bcf47e.js.map