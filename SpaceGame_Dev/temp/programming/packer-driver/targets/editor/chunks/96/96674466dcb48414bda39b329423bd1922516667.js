System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass("UIManager"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        onPlayButtonClicked() {
          const gameManager = this.getComponent(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager);
          console.log(gameManager); // gameManager.setState(GameState.GAME_START);
        }
...
//# sourceMappingURL=96674466dcb48414bda39b329423bd1922516667.js.map