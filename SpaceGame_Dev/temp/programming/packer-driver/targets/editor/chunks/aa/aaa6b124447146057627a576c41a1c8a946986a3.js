    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
        ...
        handleTouchMove(event) {
          ...
          const moveOffset = new Vec3(offset.x / this.joystickRadius, offset.y / this.joystickRadius, 0); // this.playerScript.movePlayer(moveOffset);
...
//# sourceMappingURL=aaa6b124447146057627a576c41a1c8a946986a3.js.map