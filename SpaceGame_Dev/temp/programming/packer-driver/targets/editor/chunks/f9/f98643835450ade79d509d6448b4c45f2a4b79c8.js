System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, JoystickController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoystickController", JoystickController = (_dec = ccclass("JoystickController"), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class JoystickController extends Component {
        ...
        onLoad() {
          this.joystick.inp; // this.startPos.set(this.joystick.getPosition());
...
//# sourceMappingURL=f98643835450ade79d509d6448b4c45f2a4b79c8.js.map