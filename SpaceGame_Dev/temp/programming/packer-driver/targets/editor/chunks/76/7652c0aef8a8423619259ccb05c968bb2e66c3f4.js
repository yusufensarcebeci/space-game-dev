    ...
    execute: function () {
      ...
      _export("EnemyMovement", EnemyMovement = (_dec = ccclass('EnemyMovement'), _dec2 = property(Number), _dec(_class = (_class2 = class EnemyMovement extends Component {
        ...
        update(deltaTime) {
          ...
          const newPosition = new Vec3(currentPosition.x, currentPosition.y, currentPosition.z + this.speed * deltaTime);
...
//# sourceMappingURL=7652c0aef8a8423619259ccb05c968bb2e66c3f4.js.map