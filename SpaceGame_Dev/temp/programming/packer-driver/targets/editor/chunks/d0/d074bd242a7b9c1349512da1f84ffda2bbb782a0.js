System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, randomRange, Vec3, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, EnemyManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("EnemyManager", EnemyManager = (_dec = ccclass("EnemyManager"), _dec2 = property(Prefab), _dec3 = property(Number), _dec4 = property(Number), _dec5 = property(Number), _dec6 = property(Number), _dec(_class = (_class2 = class EnemyManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        spawnEnemy() {
          ...
          if (!enemy) return;
          const spawnPos = new Vec3(randomRange(-this.spawnRangeX, this.spawnRangeX), randomRange(-this.spawnRangeY, this.spawnRangeY), this.spawnDepth);
        ...
        update(dt) {
          this.activeEnemies.forEach(enemy => {
            ...
            position.z += this.moveSpeed * dt; // Z ekseninde hareket
...
//# sourceMappingURL=d074bd242a7b9c1349512da1f84ffda2bbb782a0.js.map